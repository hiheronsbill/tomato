 ...
 **/
@Component
public class Demo1Job extends BaseJob {

    @Override
    public QuartzJobModel buildJobModel() {
        return QuartzJobModel.create()
                .withJobClass("com.mk.quartz.job.Demo1Job")
                .withCron("-")
                .withJobName("job1")
                .withJobGroup("group1")
                .withTriggerName("trigger1")
                .withTriggerGroup("triggerGroup1");
    }

    @Override
    protected void executeInternal(JobExecutionContext context) throws JobExecutionException {

        StringJoiner joiner = new StringJoiner(" demo1 开始执行 -- ")
//                .add(this.hashCode() + "")
